...
ChatUser user3 = ChatUser(
    id: '3',
    lastName: '',
    profileImage:
        'https://firebasestorage.googleapis.com/v0/b/my-vest-project.appspot.com/o/logo_splash.png?alt=media&token=11bd451e-1531-4556-a9e3-7d6871df7ac9');
...
List<ChatMessage> quickReplies = <ChatMessage>[
  ...
  ChatMessage(
    ...
    text: 'Mizo, mon chien respire mal et ne bouge plus',
    user: user,
    createdAt: DateTime.now(),
  ),
  ChatMessage(
    medias: [
      ChatMedia(
        url:
            'https://firebasestorage.googleapis.com/v0/b/my-vest-project.appspot.com/o/videoplayback.mp4?alt=media&token=45432765-cf22-4506-97dd-f0ee619e2f18',
        fileName: 'fileName',
        type: MediaType.video,
        isUploading: false,
      )
  ...
  ChatMessage(
    text: 'Bonjour, quel est votre urgence?',
    user: user3,
    createdAt: DateTime.now(),
    quickReplies: <QuickReply>[
      QuickReply(title: 'Great!'),
...
List<ChatMessage> general = <ChatMessage>[
  ChatMessage(
    text: 'Emergency',
    user: user3,
    createdAt: DateTime.now(),
