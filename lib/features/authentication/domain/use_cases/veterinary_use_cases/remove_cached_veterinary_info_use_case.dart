...
class RemoveCachedVeterinaryInfoUseCase {
  final AuthRepository authRepository;

  RemoveCachedVeterinaryInfoUseCase(this.authRepository);

  Future<Either<Failure, Unit>> removeCachedVeterinaryInfoUseCase(
    ClientEntity clientEntity,
  ) async {
    return await authRepository.removeVeterinaryInfo();
  }
}
